...
function ProductsScreen (props){
    ...
    },[successSave, successDelete]);  //if user state changed the if condition inside useEffect will run
    ...
    return <div className="content content-margined">
        ...
        <form onSubmit={submitHandler}>
            <ul className="form-container">
                ...
                <li>
                    <button type="submit" className="button primary text-center">{id? "Update": "Create"}</button>
                </li>

                <li>
                    <button type="button" onClick={()=>setModalVisible(false)} className="button secondary text-center">Back</button>
                </li>
            </ul>
        </form>
    </div> }
